...
@section('konten')
    ...
    <form action="{{ route('keranjang.update', $row->ID) }}" method="POST" onsubmit="return validasiForm()">
        @csrf
        @method('PUT')

        <p>
            <label>Kode Barang</label><br>
            <input type="text" name="KodeBarang" id="KodeBarang" value="{{ old('KodeBarang', $row->KodeBarang) }}">
        </p>

        <p>
            <label>Jumlah</label><br>
            <input type="text" name="Jumlah" id="Jumlah" value="{{ old('Jumlah', $row->Jumlah) }}">
        </p>

        <p>
            <label>Harga</label><br>
            <input type="text" name="Harga" id="Harga" value="{{ old('Harga', $row->Harga) }}">
        </p>
